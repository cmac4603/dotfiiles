return {
    ...
    config = function()
        ...
        wk.add({
            ...
            { "<leader>fda", "<CMD>Telescope diagnostics<CR>",                                                                               desc = "Find all diagnostics" },
            { "<leader>fDb", function() require 'telescope'.extensions.dap.list_breakpoints {} end,                                          desc = "Find DAP breakpoints" },
            { "<leader>fDc", function() require 'telescope'.extensions.dap.commands {} end,                                                  desc = "Find DAP commands" },
            { "<leader>fDC", function() require 'telescope'.extensions.dap.configurations {} end,                                            desc = "Find DAP configuration" },
            { "<leader>fDf", function() require 'telescope'.extensions.dap.frames {} end,                                                    desc = "Find DAP frames" },
            { "<leader>fDv", function() require 'telescope'.extensions.dap.variables {} end,                                                 desc = "Find DAP variables" },
            { "<leader>fdw", function() require('telescope.builtin').diagnostics({ severity = { min = vim.diagnostic.severity.WARN } }) end, desc = "Find diagnostics WARN or higher" },
            { "<leader>fe",  "<CMD>Telescope env<CR>",                                                                                       desc = "Find environment variables" },
            { "<leader>ff",  "<CMD>lua require'config.telescope'.project_files()<CR>",                                                       desc = "Find files (default git_files, fallback find_files)" },
            ...
            { "<leader>fh",  function() require('config.telescope').toggle_telescope(harpoon:list()) end,                                    desc = "Find harpoons" },
